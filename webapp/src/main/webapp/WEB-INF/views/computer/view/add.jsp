						...
						<form:form modelAttribute="addComputerDto" action="/webapp/computer/crud/add" onsubmit="return checkPostForm(document)" method="POST">
							<fieldset>
								<div class="form-group">
									...
									<form:input onkeyup="checkName(document)" path="name" name="name" type="text" class="form-control" id="computerName" value="${page.getComputerDto().getName()}" placeholder="${computer_name}"/>
