...
public class addComputer extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 String submitId = (String)request.getParameter("computerName");
		 System.out.println("Le computerName vaut : " + submitId);
		 
		 String introduced = (String)request.getParameter("introduced");
		 System.out.println("Le introduced vaut : " + introduced);
		 
		 String discontinued = (String)request.getParameter("discontinued");
		 System.out.println("Le discontinued vaut : " + discontinued);
