...
import com.excilys.computerdatabase.webservice.impl.rest.integration.mock.impl.MockResourceService;
...
public class ResourceImplTest extends AbstractWebserviceTest {
    @Autowired
    private MockResourceService testService;
